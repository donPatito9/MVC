...
/*A continuación, las clases que componen la Vista son, VentanaBuscar.java, VentanaPrincipal.java y 
...
public class VentanaBuscar extends JFrame implements ActionListener{
    ...
    public VentanaBuscar() {
      ...
      labelTitulo.setBounds(120, 20, 380, 25);
    ...
    public void setCoordinador(Coordinador miCoordinador){
        ...
        if(e.getSource() == botonBuscar){
         ...
         if(e.getSource()== botonEliminar){
            if(!textCod.getText().equals("")){
              int respuesta = JOptionPane.showConfirmDialog(this, "Esta seguro de eliminar la Persona", "Confirmacion", JOptionPane.YES_NO_OPTION);
     ...
     public void habilita(boolean codigo, boolean nombre, boolean edad, boolean tel, boolean profesion,
